...
import { ShoppingCart, Package, Store, Settings, ClipboardList, LogOut, Menu, X, Upload, Home, Image, Bell, AlertTriangle, BarChart2, Radio, SlidersHorizontal, Package2, Table2, FileSpreadsheet, Layers, Barcode } from 'lucide-react';
...
export default function Layout({ children }) {
  ...
  const navItemsAdmin = [
    ...
    { path: '/CodigosBarras',     label: 'Cód. Barras',  icon: Barcode },
    { path: '/ImportacionMasiva',  label: 'Imp. Masiva',  icon: Layers },
